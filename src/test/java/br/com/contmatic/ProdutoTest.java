...
public class ProdutoTest {
    ...
    @Before
    public void setUp() {
        produto1 = new Produto("Carro", "Etios", 12000.00, "Toyota", "1");
    }
    ...
    public void deve_retornar_true_se_codigo_do_produto1_for_igual_a_codigo_do_produto2() {
        Produto produto2 = new Produto("Carro", "Etios", 12000.00, "Toyota", "1");
    ...
    public void deve_retornar_true_se_preco_do_produto1_for_diferente_do_preco_do_produto2() {
        Produto produto2 = new Produto("Carro", "Etios", 60000.00, "Toyota", "1");
    ...
    public void deve_retornar_true_se_produto1_for_diferente_do_produto2() {
        Produto produto2 = new Produto("Carro2", "ETIOS-NOVO", 55000.00, "Ford", "3");
