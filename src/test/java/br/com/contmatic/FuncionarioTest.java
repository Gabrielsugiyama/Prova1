...
public class FuncionarioTest {
    ...
    public void setUp() throws ParseException {
        data = (Date) nascimento.parse("21/11/1999");
        funcionario = new Funcionario("Gabriel", "23666158846", "11963220164", data, new Endereco("FernandesPortalegre", "03523000", "774", "JardimMaringá", "São Paulo", "SP", "Brasil"));
    }
    ...
    public void deve_retornar_true_se_telefone1_for_igual_a_telefone2() {
        funcionario2 = new Funcionario("Gabriel", "23666158846", "11963220164", data, new Endereco("FernandesPortalegre", "03523000", "774", "JardimMaringá", "São Paulo", "SP", "Brasil"));
    ...
    public void deve_retornar_true_se_telefone1_for_diferente_do_telefone2() {
        funcionario2 = new Funcionario("FULANO", "12345678910", "11912345678", data, new Endereco("FernandesPortalegre", "03523000", "774", "JardimMaringá", "São Paulo", "SP", "Brasil"));
    ...
    public void deve_retornar_false_se_nome_do_funcionario_for_diferente_do_nome_do_funcionario2() {
        funcionario2 = new Funcionario("FULANO", "23666158846", "11963220164", data, new Endereco("FernandesPortalegre", "03523000", "774", "JardimMaringá", "São Paulo", "SP", "Brasil"));
    ...
    public void deve_retornar_false_se_cpf_do_funcionario_for_diferente_de_cpf_do_funcionario2() {
        funcionario2 = new Funcionario("Gabriel", "12345678910", "11963220164", data, new Endereco("FernandesPortalegre", "03523000", "774", "JardimMaringá", "São Paulo", "SP", "Brasil"));
        assertThat(funcionario, is(not(funcionario2)));
    }
    ...
    public void deve_retornar_true_se_idade_estiver_em_tostring() {
        assertThat(funcionario.toString(), containsString("dataNascimento"));
    }
    ...
    public void deve_retornar_true_se_cpf2_for_igual_a_ele_mesmo_usando_hashcode() {
        Funcionario cliente2 = new Funcionario("Gabriel", "23666158846", "11963220164", data, new Endereco("FernandesPortalegre", "03523000", "774", "JardimMaringá", "São Paulo", "SP", "Brasil"));
